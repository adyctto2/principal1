...
<body>
  ...
  <section id="container">
    ...
    <header class="header black-bg">
      ...
      <!--logo start-->
      <a href="index.html" class="logo"><b><span>QUANTUM</span>CENTER<span>BOLIVIA</span></b></a>
      <!--logo end-->
  ...
  <script type="text/javascript">
    $(document).ready(function() {
      var unique_id = $.gritter.add({
        ...
        title: 'Bienvenido a Adm de QuantumCenter Bolivia!',
